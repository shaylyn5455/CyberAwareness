...
namespace CyberAwareness_GUI
{
    public class Chatbot
    {
        ...
        // Task 4: Internal structure to store action logs
        private static List<string> activityLog = new List<string>();

        /// <summary>
        /// Logs system and user actions to maintain a history of recent events.
        /// Keeps track of the last 10 actions to remain concise.
        /// </summary>
        public static void LogAction(string description)
        {
            ...
            // Trim logs to keep only the most recent 10 items
        ...
        public string GetResponse(string input)
        {
            ...
            // --- SENTIMENT DETECTION SYSTEM (Fixes previous 0/10 mark) ---
            string sentimentPrefix = DetectSentiment(clean);

            // --- TASK 4: ACTIVITY LOG COMMAND RECOGNITION ---
            ...
            // --- TASK 3: ADVANCED NLP SIMULATION (Intent & Keyword Recognition) ---
            // Route task creation phrasing variations
            if (Regex.IsMatch(clean, @"\b(add|create|set|remind|save)\b.*\b(task|reminder|2fa|password|privacy|alert)\b"))
            {
                ...
                // Captured by UI code to open database prompts or pre-fill task fields automatically
            }

            // Route quiz initiation phrasing variations
            if (clean.Contains("quiz") || clean.Contains("play game") || clean.Contains("mini game") || clean.Contains("start test"))
            {
                ...
                // Captured by UI code to launch the Quiz interface component seamlessly
            }
        ...
        /// <summary>
        /// Analyzes the emotional content of input and changes the chatbot's dynamic tone feedback.
        /// </summary>
        private string DetectSentiment(string input)
        {
            // Negative sentiment patterns (Anger, stress, fear, confusion)
            ...
            // Positive sentiment patterns (Happiness, clarity, engagement, accomplishment)
            ...
            // Default neutral tone fallback
            return "";
        }

        /// <summary>
        /// Compiles and renders the tracked activity logs for Task 4.
        /// </summary>
